...
export const INITIAL_SYLLABUS: SyllabusRequirement[] = [
  ...
  },
  {
    ...
    awardType: 'Baden-Powell (BP) Award',
    category: 'Community Service',
    title: 'Sustainable Community Service Initiative',
    ...
    tasks: [
      ...
      { id: 'bpt-8', text: 'Partner with an NGO or public body (e.g., Environment Ministry).' },
  ...
  },
  {
    ...
    description: 'Demonstrate deep knowledge of BP heritage, Scouting history, international Scouting, and WOSM governance.',
    tasks: [
